...
public class Attendance_Fragment_Tab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try{
            ...
            mTabHost.addTab(
                    mTabHost.newTabSpec("1").setIndicator(gettabtxt("Attendance",R.drawable.add_blue)),
                    AttendanceSubmussion.class, getActivity().getIntent().getExtras());
            mTabHost.addTab(
                    mTabHost.newTabSpec("2").setIndicator(gettabtxt("View",R.drawable.list_blak)),
                    View_Attendance_Fragment.class, getActivity().getIntent().getExtras());
